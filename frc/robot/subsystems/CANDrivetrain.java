...
public class CANDrivetrain extends SubsystemBase {
  ...
  public void arcadeDrive(double speed, double rotation) {
    SmartDashboard.putNumber("speed", speed); //Put Speed variable into SmartDashboard for tracking
    SmartDashboard.putNumber("Rotation", rotation); //Put Rotation variable into SmartDashboard for tracking
    m_drivetrain.arcadeDrive((0.4 * speed), (0.4* rotation));
  }
